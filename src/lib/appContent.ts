...
export const DEFAULT_ABOUT_PAGE_CONTENT: AboutPageContent = {
    ...
    subtitle: 'The Better Pass connects travelers, local partners, verified services, and curated destination stories through one calm discovery and booking layer.',
    backgroundImages: [
